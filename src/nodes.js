...
export const popularTvShowPreviewSection = document.querySelector('#popularTvShowPreview');
...
export const popularTvShowPreviewBtn = document.querySelector('.popularTvShowPreview-btn');
